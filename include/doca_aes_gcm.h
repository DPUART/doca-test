 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_aes_gcm_cap_task_encrypt_get_max_iv_length(const struct doca_devinfo *devinfo, uint32_t *max_iv_length);
 ...
 *
 * @brief This method allocates and initializes a aes_gcm encrypt task. Task parameters can be set later on
 * by setters.
 *
 * @param [in] aes_gcm
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_aes_gcm_cap_task_decrypt_get_max_iv_length(const struct doca_devinfo *devinfo, uint32_t *max_iv_length);
 ...
 *
 * @brief This method allocates and initializes a aes_gcm decrypt task. Task parameters can be set later on
 * by setters.
 *
 * @param [in] aes_gcm
 * The aes_gcm context to allocate the task from
