...
/**
 * @brief Function to be executed on managed recveive event occurrence.
 *
 ...
 * Task error callback.
 * @param [in] task_recv_log_num
 * Log of number of doca_eth_rxq_task_recv tasks.
 *
 * @return
