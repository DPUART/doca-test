 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_eth_txq_get_max_burst_size_supported(const struct doca_devinfo *devinfo,
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_eth_txq_get_max_send_buf_list_len_supported(const struct doca_devinfo *devinfo,
							      uint32_t *max_send_buf_list_len);

/**
 * @brief Get the maximum eader size of an LSO packet supported by the device.
 *
 * @param [in] devinfo
 * Pointer to doca_devinfo instance.
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_eth_txq_get_max_lso_header_size_supported(const struct doca_devinfo *devinfo,
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_eth_txq_get_l3_chksum_offload_supported(const struct doca_devinfo *devinfo, uint8_t *offload_supported);
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_eth_txq_get_l4_chksum_offload_supported(const struct doca_devinfo *devinfo, uint8_t *offload_supported);
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_eth_txq_get_max_lso_msg_size(const struct doca_devinfo *devinfo, uint32_t *max_lso_msg_size);
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_eth_txq_get_wait_on_time_offload_supported(const struct doca_dev *dev, enum doca_eth_wait_on_time_type *wait_on_time_mode);
